                ...
                <!-- 目錄 -->
                    <div id="mul_c" class="choose_content" style="display:block;">
                        <div class="content_list">
                            ...
                            <ul>
                                <li><a href="coursev1.1.1_learn.jsp">第一节:开发前的准备<span>08：00</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="coursev1.1.2_learn.jsp">第二节:快捷键<span>03：56</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                ...
                <div id="tjcourse">
                    ...
                    <div class="right_list">
                        <ul>
                            <!-- 考虑hover时的样式 -->        
                            <li>
                                <a href="coursev_show3.jsp">初识jQuery</a>
                            </li>
                            <li>
