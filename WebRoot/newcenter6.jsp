				...
				<!-- 4、消息 -->
					<div class="con0" id="con4" style="display:none;">
						...
						<!-- 4.2、系统消息 -->
							...
							<!-- 小组消息 -->
								<div class="table_s" id="div_xzxx" style="display:none">
					...
					<!-- 6.1我的分享 -->
						<div class="con6">
							<div style="width:90%;margin:33px auto;">
								<button class="btn btn-danger"><a  href="fenxiangwz.jsp" style="text-decoration: none;color:#fff;display:block;">新建分享</a></button>
								<div class="feng_ge"></div>
								<div class="table_s">
				...
				<!-- 7、我的小组 -->
					...
					<!-- 7.0我的小组二级导航栏 -->
						<ul id="con7-tab">
							...
							<li id="xxxg" class="con0_li_noactive">信息修改</li>
					...
					<!-- 7.2任务情况 -->
						...
						<!-- 7.2.1队长 -->
				            <div class="con7_cy">
				                <div class="ren">
				                    <a href="otherCenter.jsp?hisid=17826808793"><img src="img/tx/t1.jpg" alt=""></a>
				        ...
				        <!-- 7.2.2组员1 -->
				            <div class="con7_cy">
				                <div class="ren">
				                    <a href="otherCenter.jsp?id=15011111111"><img src="img/tx/1493943455351.jpg" alt=""></a>
				                    <p class="name">浅伊_Erin</p>
				                </div>
				                <div class="am-panel-group" id="accordion">
				                    <div class="am-panel am-panel-default">
				                        <div class="am-panel-hd">
				        ...
				        <!-- 7.2.2组员2 -->
				            <div class="con7_cy">
				                <div class="ren">
				                    <a href="otherCenter.jsp?id=18911111111"><img src="img/tx/1493884051911.jpg" alt=""></a>
				                    <p class="name">蓝胖子。</p>
				                </div>
				                <div class="am-panel-group" id="accordion">
				                    <div class="am-panel am-panel-default">
								...
								<table class="table table1" style="width:500px;margin:0 150px">
									<tr>
										...
										<td style="text-align:left">
											...
											<!-- <input type="file" id="file" name="file" value="请选择头像(1:1)"/> -->
											<a href="#" id="tx_b">
												<input type="file" id="file2" name="file" value="浏览" />
												请选择头像(1:1)
											</a>
											<br>
