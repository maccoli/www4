...
<body>
    ...
    <div id="contain">
        <div id="jianj">
            <ul class="clear">
                <li>简介:</li>
                 <li>本课程对jQuery做了一个简单的介绍，介绍了jQuery用处和优点，并将其与原生的JavaScript做了一个比较，对jQuery 元素选择器和属性选择器的详细介绍及其语法的介绍。还包含了，鼠标事件，表单事件，键盘事件，事件的绑定和解绑以及自定义事件的讲解。通过本课程的学习，我们能更快速的对页面进行交互的操作。通过本课程的学习，我们可以用最少的代码做更多的事，让我们一起出发学习吧！</li>
            </ul>
        </div>
                ...
                <!-- 目錄 -->
                    <div id="mul_c" class="choose_content" style="display:block;">
                        <div class="content_list">
                            ...
                            <ul>
                                <li><a href="coursev3.1.1_learn.jsp">第一节:认识jQuery<span>03：17</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="coursev3.1.2_learn.jsp">第二节:引入jQuery的方法<span>03：32</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:jQueryHelloWord体验<span>08：12</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            <div>第二章:jQuery语法</div>
                            <ul>
                                <li><a href="#">第一节:jQuery的基本语法（一）<span>05：03</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第二节:jQuery的基本语法（二）<span>03：41</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:jQuery的基本语法（三）<span>04：15</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            <div>第三章:jQuery选择器与事件</div>
                            <ul>
                                <li><a href="#">第一节:jQuery选择器<span>06：03</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第二节:事件常用方法<span>04：28</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:绑定、解除绑定事件<span>06：30</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:事件目标与冒泡<span>09：10</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:自定义事件<span>04：56</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            ...
                            <div class="pingjia_list">
                                ...
                                <div class="pingjial_content">
                                    <ul>
                                        ...
                                        <li>
                                            初步接触jQuery果然还是要多练多记，从JS课程过来的，学JQ时总有些跳戏，之前看评论里有位同学说“JS就像是手动挡，JQ就像是自动挡”，现在我好像感受到一点这话的意思了，课程也挺好的，就是有时跨度有点大 
                                        </li>
                                        <li>
                                            2017-04-17
                                        </li>
                            ...
                            <div class="pingjia_list">
                                ...
                                <div class="pingjial_content">
                                    <ul>
                                        ...
                                        <li>
                                            有些基础的东西讲的不是特别细，没有基础的人 不容易看明白。不过总体来说很棒！
                                        </li>
                                        <li>
                                            2017-04-14
                                        </li>
                    ...
                    <div class="right_list">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="course_infor/jQuery1_code.zip" download="coursedocument">本课程相关实例源码以及课件</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div id="tjcourse">
                    ...
                    <div class="right_list">
                        <ul>
                            <!-- 考虑hover时的样式 -->        
                            <li>
                                <a href="coursev_show1.jsp">HTML5基础一</a>
                            </li>
                            <li>
