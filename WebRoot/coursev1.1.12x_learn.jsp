...
<body>
    ...
    <div id="top">
        ...
        <div id="course_title">开发前的准备</div>
    </div>
    <div id="main">
        <div id="vcourse">
            <video width="100%" controls>
                <source src="course_infor/1.1.1.mp4"  type="video/mp4">
            </video>
        </div>
        <div id="menu">
            <div id="menu_tab">
            ...
            <div id="content">
                <div id="mul_c" class="choose_content" style="display:block;">
                    <div>第一章:HTML5开发前准备</div>
                        <ul>
                            <li><a href="coursev1.1.1_learn.html">第一节:开发前的准备<span>08：00</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="coursev1.1.2_learn.html">第二节:快捷键<span>03：56</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                        </ul>
                    <div>第二章:HTML5特性简介</div>
                        <ul>
                            <li><a href="#">第一节:HTML5简介<span>03：25</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第二节:HTML5集成开发环境搭建<span>05：00</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第三节:HTML5基础详情<span>10：13</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                        </ul>
                    <div>第三章:HTML5元素、属性和格式化</div>
                        <ul>
                            <li><a href="#">第一节:HTML5元素简介及使用方法<span>06：52</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第二节:HTML5属性使用方法<span>08：31</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第三节:HTML5格式化及使用<span>05：37</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                        </ul>
                    <div>第四章:HTML5样式、链接和表格</div>
                        <ul>
                            <li><a href="#">第一节:HTML5样式的使用<span>10：42</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第二节:HTML5链接属性及使用<span>07：53</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="#">第三节:HTML5表格使用 <span>11：50</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                        </ul>
                    <div><a href="test.jsp?idctest=3" style="color:#223448;">本课程测试</a></div>
                </div>
                ...
                <div id="bij_c" class="choose_content" style="display:none;">
                    ...
                    <div id="bij_list_content"> 
                        <!-- <div class="note_list">
                            <div class="notel_hp"><a href="#"><img src="img/user1_hp.jpg"></a></div>
                            <div class="notel_content">
                                <ul>
                                    <li><a href="#">阿水12344</a></li>
                                    <li>HTML5新增了离线缓存机制</li>
                                    <li>2017-04-16<span class="zan_addOne">赞(2)</span></li>
                                </ul>
                            </div>
                        </div> -->
...
//点击记笔记，下面立即会出现内容
    ...
    oInput1.onclick=function ()
    {
        ...
        oClass1.innerHTML='<div class="notel_hp"><a href="#"><img src="img/userhp.png"></a></div><div class="notel_content"><ul><li><a href="#">用户名Erin</a></li><li>'+oText1.value+'</li><li>'+getCurrentDate()+'<span class="zan_addOne">赞(0)</span></li></ul></div>';
...
//点击提问，下面立即会出现内容
    ...
    oInput2.onclick=function ()
    {
        ...
        oClass2.innerHTML='<div class="tiwenl_hp"><a href="#"><img src="img/userhp.png"></a></div><div class="tiwenl_content"><ul><li><a href="#">用户名Erin</a></li><li>'+oText2.value+'</li><li>'+getCurrentDate()+'<span><a href="#">查看或回答</a></span><span class="zan_addOne">赞(0)</span></li></ul></div>';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $.each(jsonArray,function(i,value){
                ...
                outStr = '<div class="note_list"><div class="notel_hp"><a href="#"><img src="'+jsonCell.headp+'"></a></div><div class="notel_content"><ul><li><a href="#">'+jsonCell.nickname+'</a></li><li>'+jsonCell.bijicon+'</li><li>'+jsonCell.bijitime+'<span class="zan_addOne">赞(0)</span></li></ul></div></div>';//利用jsonCell.key1，jsonCell.key2,jsonCell.key3调用函数，并加入到要输出的html段落中
