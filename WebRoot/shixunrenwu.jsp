...
<link rel="stylesheet" href="css/sxrw_style.css">
...
//接受数据并显示
    //key1: item -实训任务文章标题,key2: time -文章时间, key3: browses -文章浏览量, key4: content -文章内容
        $.ajax({
            url : 'simulaiton.nose',//阿彪servlet调用的名字
