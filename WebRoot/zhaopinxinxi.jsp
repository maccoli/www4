...
<link rel="stylesheet" href="css/zpxx_style.css">
...
//接受数据并显示
    //key1: item -文章标题,key2: time -文章时间, key3: browses -文章浏览量, key4: content -文章内容
        $.ajax({
            url : 'recruitment.nose',//阿彪servlet调用的名字
