...
<body>
    ...
    <div id="bgimg">
        ...
        <div id="cs_title">
            <div id="cs_title_center">
                <div id="titlet">JavaScript入门</div>
    ...
    <div id="contain">
        <div id="jianj">
            <ul class="clear">
                <li>简介:</li>
                 <li>本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是本课程主要内容是。。。</li>
            </ul>
        </div>
            ...
            <div id="o_left">
                ...
                <!-- 目錄 -->
                    <div id="mul_c" class="choose_content" style="display:block;">
                        <div class="content_list">
                            <div>第一章:DIV布局</div>
                            <ul>
                                <li><a href="#">第一节:了解html<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #5eb95e;"></span></a></li>
                                <li><a href="#">第二节:开发环境准备<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #5eb95e;"></span></a></li>
                                <li><a href="#">第三节:认识html的组成结构<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第四节:网页布局之切切豆腐<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            <div>第二章:DIV布局</div>
                            <ul>
                                <li><a href="#">第一节:了解html<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第二节:开发环境准备<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:认识html的组成结构<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第四节:网页布局之切切豆腐<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            <div>第三章:DIV布局</div>
                            <ul>
                                <li><a href="#">第一节:了解html</a></li>
                                <li><a href="#">第二节:开发环境准备<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第三节:认识html的组成结构<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                                <li><a href="#">第四节:网页布局之切切豆腐<span>04:20</span><span class="am-icon-check-circle-o" style="padding:8px 0px;color: #8a8a8a;"></span></a></li>
                            </ul>
                            ...
                            <div><a href="#" style="color:#223448;">本课程测试</a></div>
                        </div>
                    </div>
                ...
                <!-- 评价 -->
                    <div id="pingj_c" class="choose_content" style="display:none;">
                        <form style="display:none;" id="pingjia_form" action="add.CourseComment">
                            <div id="star">
                                 <span>评分：</span>
                                 <ul>
                                 <li><a href=":;">1</a></li>
                        ...
                        <div id="list_content">
                            <div class="pingjia_list">
                                <div class="pingjial_hp">
                                    <img src="img/userhp.png"></div>
                                <div class="pingjial_content">
                                    <ul>
                                        <li>
                                            <a href="#">用户名Erin</a>
                                            <span>评分：<strong>8.7分</strong></span>
                                        </li>
                                        <li>
                                            这个老师讲得太仔细了，我听了完全弄懂了这个老师讲得太仔细了，我听了完全弄懂了这个老师讲得太仔细了，我听了完全弄懂了这个老师讲得太仔细了，我听了完全弄懂了这个老师讲得太仔细了，我听了完全弄懂了
                                        </li>
                                        <li>
                                            2017-2-11 16:15:01
                                        </li>
