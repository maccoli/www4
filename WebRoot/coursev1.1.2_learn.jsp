...
<body>
    ...
    <div id="top">
        ...
        <div id="course_title">快捷键</div>
    </div>
    <div id="main">
        <div id="vcourse">
            <video width="100%" controls>
                <source src="course_infor/1.1.2.mp4"  type="video/mp4">
            </video>
        </div>
        <div id="menu">
            <div id="menu_tab">
            ...
            <div id="content">
                <div id="mul_c" class="choose_content" style="display:block;">
                    <div>第一章:HTML5开发前准备</div>
                        <ul>
                            <li><a href="coursev1.1.1_learn.jsp">第一节:开发前的准备<span>08：00</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                            <li><a href="coursev1.1.2_learn.jsp">第二节:快捷键<span>03：56</span><span class="am-icon-check-circle-o" style="padding:4px 0px;color: #8a8a8a;"></span></span></a></li>
                        </ul>
                    ...
                    <div><a href="test_HTML5_one.jsp" style="color:#223448;">本课程测试</a></div>
                </div>
